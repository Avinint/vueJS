<template>
  <button @click="ajouter()" :class="[type, icon_placement]" type="button" data-modal-toggle="add-user-modal" class="flex items-center space-x-1 justify-center px-3 py-2 text-sm font-medium text-center rounded-lg">
