    ...
    <div :class="'relative max-h-full w-9/12 max-w-'+props.size">
      <div class="relative bg-white rounded-lg shadow">
        ...
        <div v-if="props.type === 'classic'"
          class="flex justify-end items-center p-6 space-x-2 rounded-b">
        ...
        <div v-if="props.type === 'alert'"
          class="flex justify-end items-center p-6 space-x-2 rounded-b">
          <Button test='TcancelModal' @click="emit('cancel', $event)" label="Annuler" couleur="secondary" class="border border-red-600" />
