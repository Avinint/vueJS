<template>
  <button :class="[couleur, icon_placement, border]" :type="submit ? 'submit' : 'button'" data-modal-toggle="add-user-modal" class="inline-flex items-center space-x-2 justify-center px-6 py-3 text-sm font-medium text-center rounded-lg">
