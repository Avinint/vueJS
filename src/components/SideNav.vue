<template>
  <aside id="logo-sidebar" class="fixed top-0 left-0  z-20 flex flex-col flex-shrink-0 hidden w-64 h-full font-normal duration-75 lg:flex transition-width" aria-label="Sidebar">
    ...
    <div class="h-full overflow-y-auto bg-white ">
      <div v-for="(link, i) in links" class="flex flex-col items-center text-base font-normal text-gray-900 ">
        <div class="flex items-center ml-10 px-1 py-2 w-full" :class="link.divider ? 'text-xl -ml-6 text-red-600' : 'hover:bg-gray-100 text-sm'">
