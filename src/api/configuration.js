...
export const getConfigActiviteById = async (activite_id) => {
  const response = await $fetch(
    `${import.meta.env.VITE_API_URL}/api/configuration/activite/${activite_id}`,
    {
      method: 'get',
      headers: {
        ...defaultHeaders,
...
export const getConfigFitArenaById = async (fitArena_id) => {
  const response = await $fetch(
    ...
    }/api/configuration/fit_arena/${fitArena_id}`,
    {
      method: 'get',
      headers: {
        ...defaultHeaders,
...
export const getConfigZoneById = async (zone_id) => {
  const response = await $fetch(
    `${import.meta.env.VITE_API_URL}/api/configuration/zone/${zone_id}`,
    {
      method: 'get',
      headers: {
        ...defaultHeaders,
