...
export const getParametres = async (page = 1) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametres?page=${page}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
...
export const getParametresById = async (id) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametres/${id}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
...
export const postParametres = async (param) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametres`, {
        method:'post',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
