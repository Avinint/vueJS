...
export const getParametreActivite = async (page = 1) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_activites?page=${page}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
...
export const getParametreActiviteById = async (id) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_activites/${id}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
...
export const postParametreActivite = async (param) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_activites`, {
        method:'post',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
