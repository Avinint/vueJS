...
export const getParametreFitArena = async (page = 1, query = '') => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_fit_arenas?page=${page}${query}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
...
export const getParametreFitArenaById = async (id) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_fit_arenas/${id}`, {
        method:'get',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
...
export const postParametreFitArena = async (param) => {
    const response = await $fetch(`${import.meta.env.VITE_API_URL}/api/parametre_fit_arenas`, {
        method:'post',
        headers: {
            ...defaultHeaders,
            'Content-Type': 'application/ld+json',
