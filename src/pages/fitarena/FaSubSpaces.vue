<template>
  ...
  <Modal v-if="subEspace_modal" :type="readonly ? 'visualiser' : 'classic' " :title="readonly ? 'Information d\'un sous-espace' : 'Ajouter ou modifier un sous-espace'" @cancel="subEspace_modal = false, cancel()" @confirm="saveEspace">
